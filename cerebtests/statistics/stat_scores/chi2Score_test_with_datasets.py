# ~/cerebtests/statistics/stat_scores/chi2Score_test_with_datasets.py
import unittest
...
class Chi2ScoreTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Since in cerebtests the score classes accept only experimental observation and
    ...
    def test_4_ear_infection_xylitol_2by3(self):
        ...
        self.assertEqual( [round(x["test_statistic"], 2), x["df"], p_interval],
                          [6.69, 2, True] )
        # Notice that for (3 x 2 version, no compatible with cerebtests)
        # Original question: does taking xylitol sweetener prevent ear infection?
